...
trait Historisable
{
    ...
    public function set_historised($val)
    {
        ...
        } elseif (method_exists($this, 'removeHook')) {
            $this->removeHook('after_save', 'historise', 'pragma:historic:historise');
            $this->removeHook('before_save', 'init_was_new', 'pragma:historic:init_was_new');
            $this->removeHook('before_delete', 'deleted_entry', 'pragma:historic:deleted_entry');
            $this->removeHook('after_open', 'init_histo_values', 'pragma:historic:init_histo_values');
            $this->removeHook('after_open', 'init_initial_global_name', 'pragma:historic:init_initial_global_name');
            $this->removeHook('after_build', 'init_histo_values', 'pragma:historic:init_histo_values_build');
        }
    }
